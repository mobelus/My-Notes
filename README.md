...
# Сортировки время работы в лучшем / худшем случае:

# Сортировки / Гарантированно работающая за O(log(n)):



# Виртуальный конструктор / Может ли быть конструктор виртуальным:

Конструктор должен проинициализировать указатель на таблицу виртуальных функций, чего он не сможет сделать, если сам будет виртуальным.
