...
explicit (ПРИМЕР см. 2 вопросами ниже)
...
Это модификатор для зпрета неявного преобразования типов объектов аргументов конструктора.
...
```
ЕСЛИ напишем: **explicit B(int var) : m_var(var) { }**
